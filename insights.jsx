  ...
  <div className="overflow-x-auto">
    <table className="w-full">
      ...
      <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
        {monthlyData.map((row) => (
         <tr key={row.month} className="hover:bg-cyan-50 light:hover:bg-cyan-800">
            <td className="py-3 text-sm text-cyan-700 dark:text-gray-900 font-medium">{row.month}</td>
      ...
      {/* TIPS */}
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:bg-gradient-to-r dark:from-gray-900 dark:to-indigo-950 rounded-2xl p-6 border border-blue-100 dark:border-gray-700">
